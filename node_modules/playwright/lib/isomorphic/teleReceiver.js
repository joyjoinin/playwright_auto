...
class TeleReporterReceiver {
  ...
  async _onEnd(result) {
    ...
    await ((_this$_reporter$onEnd = (_this$_reporter9 = this._reporter).onEnd) === null || _this$_reporter$onEnd === void 0 ? void 0 : _this$_reporter$onEnd.call(_this$_reporter9, {
